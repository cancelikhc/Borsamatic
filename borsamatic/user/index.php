...
<body>
    ...
    ***********************************-->
    <div id="main-wrapper">
		...
		<?php include 'inc/xu100.php'; ?>
		<?php include 'inc/dovizGetir.php'; ?>
        ...
        <div class="content-body">
			<div class="container-fluid">
				<div class="form-head mb-sm-5 mb-3 d-flex flex-wrap align-items-center">
					<h2 class="font-w600 mb-2 mr-auto ">Ana Sayfa</h2>
				...
				<div class="row">
					<div class="col-xl-3 col-sm-6 m-t35">
						<div class="card card-coin">
							...
							<div class="mb-3 dovizOrtalama"><i class="fa-solid fa-dollar-sign dovizBoyut" style="color: white"></i></div>

							
								<h2 class="text-black mb-2 font-w600" style="color: #1BFF00 !important"><?php echo $dolar; ?> ₺</h2>
								<p class="mb-0 fs-14" style="color: white">
					...
					<div class="col-xl-3 col-sm-6 m-t35">
						<div class="card card-coin">
							<div class="card-body text-center">
								<div class="mb-3 dovizOrtalama"><i class="fa-solid fa-euro-sign dovizBoyut" style="color: white"></i></div>
							
							<h2 class="text-black mb-2 font-w600" style="color: #1BFF00 !important"><?php echo $eur; ?> ₺</h2>
								<p class="mb-0 fs-13" style="color: white">
									EUR
								</p>	
							</div>
						</div>
					...
					<div class="col-xl-3 col-sm-6 m-t35">
						<div class="card card-coin">
							<div class="card-body text-center">
							<div class="mb-3 dovizOrtalama"><i class="fa-solid fa-coins dovizBoyut" style="color: white"></i></div>
								<h2 class="text-black mb-2 font-w600" style="color: #1BFF00 !important"><?php echo $altin; ?> ₺</h2>
								<p class="mb-0 fs-14" style="color: white">
									ALTIN
								</p>	
							</div>
					...
					<div class="col-xl-3 col-sm-6 m-t35">
						<div class="card card-coin">
							<div class="card-body text-center">
							<div class="mb-3 dovizOrtalama"><i class="fa-brands fa-btc dovizBoyut" style="color: white"></i></div>
								<h2 class="text-black mb-2 font-w600" style="color: #1BFF00 !important"><?php echo $btc; ?> ₺</h2>
								<p class="mb-0 fs-14" style="color: white">
									BTC
								</p>	
							</div>
					...
					<div class="col-xl-9 col-xxl-8">
						<div class="card">
							<div class="card-header border-0 flex-wrap pb-0">
								<div class="mb-3">
									<h4 class="fs-20 text-black">BIST 100 Endeksi</h4>
									<p class="mb-0 fs-20 text-black">

									<?php foreach($bist['result'] as $k => $v){echo $v['currentstr'] . '₺';} ?>
							...
							<div class="card-body pb-0">
								...
								<div class="chart-content">	
									<div class="d-flex justify-content-between mb-2 align-items-center">
										...
										<div>
											<h5 class="mb-0"><?php foreach($bist['result'] as $k => $v){echo $v['changerate'] . '%';} ?></h5>
										</div>
									</div>
									<div class="d-flex justify-content-between mb-2 align-items-center">
										<div>
											...
											<span class="fs-14">Açılış</span>
										</div>
										<div>
											<h5 class="mb-0"><?php foreach($bist['result'] as $k => $v){echo $v['opening'] . '₺';} ?></h5>
										</div>
									</div>
									<div class="d-flex justify-content-between mb-2 align-items-center">
										<div>
											...
											<span class="fs-14">Kapanış</span>
										</div>
										<div>
											<h5 class="mb-0"><?php foreach($bist['result'] as $k => $v){echo $v['closing'] . '₺';} ?></h5>
										</div>
									</div>
									<div class="d-flex justify-content-between mb-2 align-items-center">
										<div>
											...
											<span class="fs-14">Kapanış Saati</span>
										</div>
										<div>
											<h5 class="mb-0"><?php foreach($bist['result'] as $k => $v){echo $v['time'];} ?></h5>
										</div>
									</div>
								</div>	
							</div>
    ...
    ***********************************-->
	...
	<script>
        ...
        .then(data => {
            ...
            const currency = 'XU100'; // Örneğin sadece dolar olarak aldım, dinamik olarak da alabilirsiniz

            // Grafiği oluşturma
            const ctx = document.getElementById('xus100').getContext('2d');
            const myChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: data[currency].map(entry => entry.current),
                        fill: false,
	...
	<script>
        ...
        function createChart() {
            ...
            // Grafik ayarları
            var ctx = document.getElementById('xu100').getContext('2d');
            ...
            // Grafik güncelleme kodu
            function updateChart() {
                // API'den dolar fiyatı almak için AJAX isteği gönderin
                var xhr = new XMLHttpRequest();
                xhr.open('GET', 'abc.php', true);
                xhr.onload = function() {
                    if (xhr.status >= 200 && xhr.status < 300) {
                        // Başarılı yanıt aldıysanız veriyi güncelleyin ve grafik yenileyin
                        var responseData = JSON.parse(xhr.responseText);

						var responseData = JSON.parse(xhr.responseText);
                        usdChart.data.labels.push(new Date().toLocaleTimeString());
                        usdChart.data.datasets[0].data.push(responseData.price);
                        // En fazla 10 veri tut
                        if (usdChart.data.labels.length > 10) {
                            usdChart.data.labels.shift();
                            usdChart.data.datasets[0].data.shift();
                        }
                        usdChart.update();
                    }
                };
            ...
            // Her saniye grafik güncelleme fonksiyonunu çağır
